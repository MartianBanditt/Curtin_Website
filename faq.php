    ...
    <main>
        ...
        <div class="full-width-background my-5 py-5 bg-secondary-blue" id="about-us">
            <div class="container accordion" id="accordionExample2">
                ...
                <!-- Question for user -->
                <div class="row bg-third p-2 m-auto question-box collapsed" id="headingOne" data-toggle="collapse" data-target="#collapseOne" role="button" aria-expanded="false" aria-controls="collapseOne">
                ...
                <!-- Question for user -->
                <div class="row bg-third p-2 m-auto question-box collapsed" id="headingTwo" data-toggle="collapse" data-target="#collapseTwo" role="button" aria-expanded="false" aria-controls="collapseTwo">
                ...
                <!-- Question for user -->
                <div class="row bg-third p-2 m-auto question-box collapsed" id="headingThree" data-toggle="collapse" data-target="#collapseThree" role="button" aria-expanded="false" aria-controls="collapseThree">
